...
internal var packageDependencies: [Package.Dependency] = [
    ...
    .package(url: "https://github.com/apple/swift-crypto", .upToNextMajor(from: "2.2.1")),
    .package(url: "https://github.com/MihaelIsaev/FCM.git", .upToNextMajor(from: "2.7.0")),
    .package(url: "https://github.com/Fondation-Dedici/swift-dedici-c25519", .upToNextMajor(from: "1.3.3")),
...
internal var targetDependencies: [Target.Dependency] = [
    ...
    .product(name: "DediciC25519", package: "swift-dedici-c25519"),
